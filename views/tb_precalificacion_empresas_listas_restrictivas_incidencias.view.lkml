view: tb_precalificacion_empresas_listas_restrictivas_incidencias {
  sql_table_name: bd_ic_cliente.tb_precalificacion_empresas_listas_restrictivas_incidencias ;;
  drill_fields: [id]
