view: paa_linea_otrocamp {
  sql_table_name: bd_ic_cliente.paa_linea_otrocamp ;;
  drill_fields: [id]
  ...
  dimension: otros_usuarios {
    type: string
    sql: ${TABLE}.otros_usuarios ;;
  }
  dimension: pcc_id {
    type: number
    sql: ${TABLE}.pcc_id ;;
  ...
  dimension: porcentaje_capex {
    type: string
    sql: ${TABLE}.porcentaje_capex ;;
  }
  dimension: porcentaje_opex {
    type: string
    sql: ${TABLE}.porcentaje_opex ;;
  }
  dimension: profesional_abas {
    type: string
    sql: ${TABLE}.profesional_abas ;;
  }
  dimension: requiere_contrato {
    type: string
    sql: ${TABLE}.requiere_contrato ;;
  }
  ...
  dimension: valor_estimado_capex {
    type: string
    sql: ${TABLE}.valor_estimado_capex ;;
  }
  dimension: valor_estimado_contrato {
    type: string
    sql: ${TABLE}.valor_estimado_contrato ;;
  }
  dimension: valor_estimado_contrato_cop {
    type: string
    sql: ${TABLE}.valor_estimado_contrato_cop ;;
  }
  dimension: valor_estimado_opex {
    type: string
    sql: ${TABLE}.valor_estimado_opex ;;
  }
