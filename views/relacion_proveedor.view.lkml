view: relacion_proveedor {
  sql_table_name: bd_ic_cliente.relacion_proveedor ;;
  drill_fields: [id]
  ...
  dimension: aumentar_oportunidades {
    type: string
    sql: ${TABLE}.aumentar_oportunidades ;;
  }
  dimension: autoridad_irrestricta {
    type: string
    sql: ${TABLE}.autoridad_irrestricta ;;
  }
