view: validacion_cliente {
  sql_table_name: bd_ic_cliente.validacion_cliente ;;
  drill_fields: [id]
  ...
  dimension_group: fecha_tipo_anterior {
    type: time
    timeframes: [raw, time, date, week, month, quarter, year]
    sql: ${TABLE}.fecha_tipo_anterior ;;
  }
