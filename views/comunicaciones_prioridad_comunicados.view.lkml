view: comunicaciones_prioridad_comunicados {
  sql_table_name: bd_ic_cliente.comunicaciones_prioridad_comunicados ;;
  drill_fields: [id]
  ...
  dimension: smtp_transaction_id {
    type: string
    sql: ${TABLE}.smtp_transaction_id ;;
  }
